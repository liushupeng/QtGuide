...
void ConfigManager::readGeneralSettings()
{
    if (settings->contains("Editor/FontFamily")) {
        ...
        editorFontFamily = QFontDatabase::systemFont(QFontDatabase::FixedFont).toString();
    }
    ...
    editorIndentMode = settings->value("Editor/IndentMode", "Spaces").toString();
}

QString ConfigManager::getEditorFontFamily() const
{
...
QString ConfigManager::getStyleTheme() const
{
    return styleTheme;
}
...
QString ConfigManager::getEditorColorTheme() const
{
...
int ConfigManager::getEditorTabSize() const
{
...
QString ConfigManager::getEditorIndentMode() const
{
    return editorIndentMode;
}
